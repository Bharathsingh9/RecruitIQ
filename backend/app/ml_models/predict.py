...
# Dynamically resolve model path relative to this file's folder
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
MODEL_PATH = os.path.join(CURRENT_DIR, "candidate_ranker.joblib")
...
def predict_candidate(
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        from app.ml_models.train import train_model
        train_model()
